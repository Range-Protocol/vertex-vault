...
contract SkateVertexVaultTest is Test {
    ...
    function testRewardClaiming() external {
        ...
        deal(wmnt, address(vault), amount);

        bytes32 wmtnMerkleRoot = 0xe5853a4c0f7fd371e08be46e8cadaae72efa333f12af35756f617920fb2ca38e;
        vm.expectEmit();
        emit MerkleRootsSet(wmtnMerkleRoot);
        vault.setMerkleRoots(wmtnMerkleRoot);

        //        assertEq(IERC20(arb).balanceOf(0xBBE307DB73D8fD981A7dAB929E2a41225CF0658A, 0);
        //        assertEq(IERC20(vrtx).balanceOf(address(this)), 0);
        console2.log(IERC20(wmnt).balanceOf(0xBBE307DB73D8fD981A7dAB929E2a41225CF0658A));

        bytes32[] memory proofWmnt = new bytes32[](1);
        proofWmnt[0] = 0x1327ebc3316a133fb6a50245b3b6abd9ad0fe0ec187333b821a09d745062732b;
        //
        vault.claim(wmnt, 0xBBE307DB73D8fD981A7dAB929E2a41225CF0658A, amount, proofWmnt);
        assertEq(vault.wmntClaimedAmounts(address(0xBBE307DB73D8fD981A7dAB929E2a41225CF0658A)), amount);
        console2.log(IERC20(wmnt).balanceOf(0xBBE307DB73D8fD981A7dAB929E2a41225CF0658A));
    }
